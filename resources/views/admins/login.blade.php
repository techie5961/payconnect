...
@section('main')
    <section class="w-full bg-white p-bottom-50 align-center br-20 box-shadow-silver p-y-20 g-10 column p-10 backdrop-blur-10 max-w-500">
        ...
        <input type="hidden" value="{{ csrf_token() }}" name="_token" class="input">
            ...
            <input placeholder="Admin Tag" name="id" class="w-full input inp required ph-c-silver h-full no-border no-outline bg-transparent br-10" type="text">
        ...
        <div class="h-50 align-center w-full row border-1 cont  border-color-silver bg-whitesmoke br-10 bg-dim">
            <input placeholder="Password" class="w-full inp required input ph-c-silver h-full no-border no-outline bg-transparent br-10" name="password" type="password">
        <div style="height:40px;margin-right:5px !important;" class="h-semi-full perfect-square br-10 bg-silver right-10 column justify-center">
