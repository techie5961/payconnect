...
@endsection
@section('main')
    <section class="w-full bg-white p-bottom-50 align-center br-20 box-shadow-silver p-y-20 g-10 column p-10 backdrop-blur-10 max-w-500 overflow-hidden">
        ...
        <div style="height:40px;margin-right:5px !important;" class="h-semi-full perfect-square br-10 bg-silver right-10 column justify-center">
          ...
          <a href="{{ url('register') }}" class="c-primary">New User? Register  Now</a>
    </section>
@endsection
@section('js')
    <script class="js">
